          ...
          >
            ...
            <div className="flex flex-col justify-end gap-2">
              {!item.cancelled && item.payment && !item.isCompleted && (
                <button className="sm:min-w-48 py-2 border  rounded text-stone-500 bg-indigo-50 text-center">
                  Paid
                </button>
              )}
              {!item.cancelled && !item.payment && !item.isCompleted && (
              ...
              {
                item.isCompleted &&<button className="sm:min-w-48 py-2 border border-red-500 rounded text-green-500 text-center">Completed</button>
              }
            </div>
          </div>
        ))}
